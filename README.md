...
<td markdown="span">A website that demonstrates HTLM5 {: .label } CSS3 CSS Grid JavaScript NodeJS ExpressJS Git commits Github repository responsive design ADA compliance GDPR cookies GET and POST requests MVC </td>
